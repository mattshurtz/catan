...
//        instance.updateGame();
    ...
    public void testClearGames() throws Exception {
        ...
        SQLGamesDAO instance = null;
        instance = new SQLGamesDAO(new SQLConnectionUtility());
        instance.clearGames();
        // TODO review the generated test code and remove the default call to fail.
    }
    ...
    public void testAddCommand() throws Exception {
        ...
        SQLGamesDAO instance = new SQLGamesDAO(new SQLConnectionUtility());
                ...
                instance.addCommand("hello","world",2,3,9,"eighty");
    ...
    public void testGetCommand() throws Exception {
        ...
        SQLGamesDAO instance = new SQLGamesDAO(new SQLConnectionUtility());
                ...
                ArrayList<CommandParam> commandParams = instance.getCommands(3,3);
