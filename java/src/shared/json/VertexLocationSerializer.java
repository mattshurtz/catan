 ...
 * @author JanPaul
 */
public class VertexLocationSerializer implements JsonSerializer<VertexLocation> {

    @Override
    public JsonElement serialize(VertexLocation t, Type type, JsonSerializationContext jsc) {
